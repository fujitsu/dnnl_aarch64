...
INST_TEST_CASE(Simple_Blocked16_padded,
    // non-1x1 (all)
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED16, FMT_BIAS, FMT_DATA_BLOCKED16, 1, 1, 16, 9, 9, 64, 8, 8, 3, 3, 0, 0, 1, 1),
    ...
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED16, FMT_BIAS, FMT_DATA_BLOCKED16, 2, 1, 16, 8, 8, 16, 8, 8, 1, 1, 0, 0, 1, 1),
