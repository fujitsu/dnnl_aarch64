...
#include "jit_sve_x8s8s32x_convolution.hpp"
...
void jit_sve_x8s8s32x_convolution_fwd_t<src_type,
...
template struct jit_sve_x8s8s32x_convolution_fwd_t< data_type::s8, data_type::u8>;
template struct jit_sve_x8s8s32x_convolution_fwd_t< data_type::u8, data_type::u8>;
template struct jit_sve_x8s8s32x_convolution_fwd_t< data_type::s8, data_type::s8>;
template struct jit_sve_x8s8s32x_convolution_fwd_t< data_type::u8, data_type::s8>;
template struct jit_sve_x8s8s32x_convolution_fwd_t< data_type::s8, data_type::s32>;
template struct jit_sve_x8s8s32x_convolution_fwd_t< data_type::u8, data_type::s32>;
template struct jit_sve_x8s8s32x_convolution_fwd_t< data_type::s8, data_type::f32>;
template struct jit_sve_x8s8s32x_convolution_fwd_t< data_type::u8, data_type::f32>;
}
}
}
