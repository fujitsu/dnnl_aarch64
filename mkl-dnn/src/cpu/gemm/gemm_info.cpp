            ...
            for (int isSum : { no_sum, do_sum }) {
                ...
                if (p_copy_a != NULL)
                    copyA[isTrans][isSum] = p_copy_a->getCode<void (*)(
                            const dim_t *, const dim_t *, const a_type *,
                ...
                if (p_copy_b != NULL)
                    copyB[isTrans][isSum] = p_copy_b->getCode<void (*)(
                            const dim_t *, const dim_t *, const b_type *,
                    ...
                    if (p_kernel != NULL)
                        kern[isBeta0][isColOffset][isRowOffset]
                                = p_kernel->getCode<void (*)(const dim_t *,
                                        ...
                                        const float *, const a_type *,
                                        const b_type *, c_type *, const dim_t,
                                        const c_type *, const c_type *)>();
                }
