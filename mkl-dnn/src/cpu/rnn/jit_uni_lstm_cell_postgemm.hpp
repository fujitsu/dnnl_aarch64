...
#ifdef __ARM_ARCH
    typedef typename jit_uni_eltwise_injector_f32<sve>::Vmm injector_t;
#else
...
#ifdef __ARM_ARCH
template struct jit_uni_lstm_cell_postgemm_fwd<sve, data_type::f32>;
template struct jit_uni_lstm_cell_postgemm_fwd<sve, data_type::u8>;
#else
