        ...
        const data_i_t *src, const data_o_t *dst)
{
    ...
    std::cout << "Input map index" << std::endl;
    for (size_t i = 0; i < nelems; ++i) {
      size_t idx = map_index(md_i, i, false);
    ...
    std::cout << "Output map index" << std::endl;
    for (size_t i = 0; i < nelems; ++i) {
      size_t idx = map_index(md_o, i, false);
      std::cout << idx << ", ";
      if (i % 16 == 15) {
	std::cout << std::endl;
      }
    ...
    std::cout << "Output (map index order)" << std::endl;
    for (size_t i = 0; i < nelems; ++i) {
    ...
    std::cout << "Output (array index order)" << std::endl;
    for (size_t i = 0; i < nelems; ++i) {
      data_o_t d = dst[i];
      std::cout << d << ", ";
      if (i % 16 == 15) {
